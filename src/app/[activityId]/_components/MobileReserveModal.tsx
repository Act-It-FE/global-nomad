...
export default function MobileReserveModal({
  ...
  const [isPastModalOpen, setIsPastModalOpen] = useState(false); // ✅ 추가
                ...
                {dates.map((date) => {
                  ...
                  return (
                    <div
                      ...
                      className={`txt-16_M flex aspect-square items-center justify-center rounded-full ${
                        isAvailable && !past
                          ? 'hover:bg-primary-100 hover:text-primary-500 cursor-pointer text-gray-800'
