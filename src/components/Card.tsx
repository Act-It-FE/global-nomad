...
export default function Card({ image, title, rating, reviewCount, price, id }) {
  ...
  return (
    <Link
      className='relative aspect-[155/177] w-full md:aspect-[332/347] lg:h-290 lg:w-262'
      href={`/${id}`}
    >
      <Image
        fill
        ...
        src={image}
      />
      <article className='absolute bottom-[-66px] flex w-full flex-col gap-4 rounded-[18px] bg-white px-17 py-16 text-gray-950 shadow-[-4.5px_-4.5px_11.25px_0px_rgba(0,0,0,0.05)] md:bottom-[-76px] md:gap-2 md:rounded-[32px] md:px-30 md:py-20'>
